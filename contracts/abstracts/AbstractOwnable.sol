...
abstract contract AbstractOwnable is IAdmin {
    ...
    /**
     * @notice Initializes the precompiled contract's owner.
     ...
     */
    function _initialPrecompileOwner(address initialOwner) internal {
        ...
        require(_precompiled.initializeOwner(initialOwner));
    ...
    function transferAdmin(address newAdmin) public override onlyAdmin returns (bool) {
